    ...
    <div>
                    ...
                    <div class="mt-2 grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div v-for="permission in availablePermissions" :key="permission">
                            <label class="flex items-center">
                                ...
                                <span class="ms-2 text-sm text-gray-600 darrk:text-gray-400">{{ permission }}</span>
                            </label>
                        </div>
                    </div>
                </div>
                    ...
                    <template #content>
                        <div class="space-y-6">
                            <div v-for="token in tokens" :key="token.id" class="flex items-center justify-between">
                                <div class="break-all darrk:text-white">
                                    {{ token.name }}
                                </div>
        ...
        <DialogModal :show="displayingToken" @close="displayingToken = false">
            ...
            <template #content>
                ...
                <div v-if="$page.props.jetstream.flash.token" class="mt-4 bg-gray-100 darrk:bg-gray-900 px-4 py-2 rounded font-mono text-sm text-gray-500 break-all">
