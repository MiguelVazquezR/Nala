                                ...
                                <Dropdown align="right" width="48">
                                    <template #trigger>
                                        ...
                                        <span v-else class="inline-flex rounded-full">
                                            <button type="button" :class="route().current('profile.*') ? 'border-primary' : ''" class="inline-flex items-center py-2 px-[13px] border border-gray-200 text-base rounded-full text-gray-500 bg-transparent hover:text-gray-800 active:border-primary focus:border-primary transition ease-in-out duration-200">
                                                {{ 'N' }}
                                            </button>
                                        </span>
                                    </template>
